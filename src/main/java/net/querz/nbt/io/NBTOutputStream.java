...
public class NBTOutputStream extends DataOutputStream implements NBTOutput, MaxDepthIO {
	...
	private static void writeChar(NBTOutputStream out, Tag<?> tag) throws IOException {
	...
	private static void writeStringArray(NBTOutputStream out, Tag<?> tag) throws IOException {
